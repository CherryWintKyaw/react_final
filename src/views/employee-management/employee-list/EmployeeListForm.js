...
function EmployeeListForm(props) {
  ...
  let { userName, userNameChange, genderData, selectGender, selectGenderChange,
    ...
    editClick, delClick, confirmtype, content, deleteOK } = props;
  return (
    <div className='mt-4'>
      ...
      <CRow alignHorizontal="center" className="mt-5">
        <CButton onClick={searchClick} style={{ backgroundColor: 'brown'}}>
          Search
        </CButton>
      </CRow>
      <CRow className='mt-5'>
            ...
            <>
              ...
              <div className='overflow'>
                <table className='table table-striped'>
                  <thead style={{backgroundColor: "#e657c8d6",color: "white" }} >
                    <tr>
